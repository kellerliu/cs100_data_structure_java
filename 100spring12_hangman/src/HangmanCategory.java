 ...
 * the start, you'll likely not keep it in your final game except for readString
 * 
 * @author Junfei Liu
 * 
 */
...
public class HangmanCategory {
	...
	public HangmanCategory() {
		myInput = new Scanner(new BufferedReader(new InputStreamReader(
				System.in)));
	}
	 ...
	 * play a complete game You'll likely want to call other functions from this
	 * one.
	 */
	public void playcategory() {
		String choice = readString("Please enter'a','b'or'c' to choose game category: [a]fruits [b]animals [c]colors");
		...
		String secretWord = data.getcategoryWord();
		...
		// System.out.println(wordlength+" letter secret word is " +
		// secretWord);
